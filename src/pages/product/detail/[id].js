    ...
    <div style={{ margin: "0 1rem" }}>
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            Premium Canvas - UV and water resistant canvas cotton bullion fringe
          </li>
          <li>
            Reclaimed Timber - Eco friendly, world forestripes approved
        ...
        <br />
        <br />
        An oversize shipping charge of $10.00 will be applied to your total for
        each umbrella ordered. Expedited shipping is not available. We are
        unable to ship this item to P.O. boxes, military facilities or outside
              ...
              <div style={{ display: "flex", marginBottom: "2rem" }}>
                <Video>
                  <VideoCard
                    videoId="001nQnpYxJg"
                    thumbnail={
                      "https://img.youtube.com/vi/001nQnpYxJg/maxresdefault.jpg"
                    }
                  />
                </Video>
                <VideoMessage>
